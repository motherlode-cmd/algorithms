...
public:
    ...
    void setupUi(QWidget *FormPassanger)
    {
        if (FormPassanger->objectName().isEmpty())
            FormPassanger->setObjectName(QString::fromUtf8("FormPassanger"));
        ...
        lineEdit_passport_num->setObjectName(QString::fromUtf8("lineEdit_passport_num"));
        lineEdit_passport_num->setGeometry(QRect(240, 20, 113, 25));
        lineEdit_date_passport = new QLineEdit(FormPassanger);
        lineEdit_date_passport->setObjectName(QString::fromUtf8("lineEdit_date_passport"));
